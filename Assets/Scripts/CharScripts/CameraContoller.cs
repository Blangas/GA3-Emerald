...
public class CameraContoller : MonoBehaviour
{
    ...
    public float hgtFromTarget = 2;
    public float lookFromTarget = 1;
    ...
    void CameraMovement()
    {
        ...
        Vector3 hgt = new Vector3(0, hgtFromTarget, 0);

        transform.position = target.transform.position - transform.forward * dstFromTarget + hgt + transform.up * lookFromTarget;
    }
